...
class UnionLayer(nn.Module):
    ...
    def forward(self, x: Tensor, x_gcn: Tensor, mask: Tensor, length: Tensor, tags, validation=False):
        '''
...
class Decoder(nn.Module):
    ...
    def forward(self, x: Tensor, x_gcn: Tensor, mask: Tensor, length: Tensor, tags: Tensor, validation=False):
        '''
        ...
        new_x, new_mask, doc_seq_len, new_tag = self.union_layer(x, x_gcn, mask, length, tags, validation)
